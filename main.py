...
def get_thema_coinfo(html, thema_name):
    ...
    for el in soups:
        ...
        co_info_lst = [thema_name, info_co_name, info_txt, int(info_vals[AVSL].get_text().replace(',','')), info_vals[B_PROFIT].get_text(),
                       info_vals[B_PROFIT_RATE].get_text(), info_vals[FORIGN_RATE].get_text(), info_vals[PER].get_text()]
